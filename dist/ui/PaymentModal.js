...
export function createPaymentModal(sdk, onClose, { orderId, amount }) {
    ...
    root.style.setProperty('--payment-primary-color', sdk.theme?.primaryColor || '#0070f3');
    root.style.setProperty('--payment-secondary-color', sdk.theme?.secondaryColor || '#fff');
  ...
  `;
    ...
    Object.assign(paymentLoader.querySelector('.loader').style, paymentStyles.loader.spinner);
    Object.assign(paymentLoader.querySelector('p').style, paymentStyles.loader.text);
