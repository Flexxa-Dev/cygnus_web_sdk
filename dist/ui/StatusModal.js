...
export function createStatusModal(type, message) {
    ...
    if (!container) {
        console.warn("Payment element container not found, creating fallback container");
        ...
        if (paymentContainer) {
            ...
            const modalContent = paymentContainer.querySelector(".payment-modal-content");
            if (modalContent) {
    ...
    try {
        ...
        if (statusModal) {
            ...
            if (statusIcon) {
                ...
                Object.assign(statusIcon.style, type === "success"
            ...
            if (title) {
                ...
                Object.assign(title.style, type === "success"
